...
echo "  2. Run:  cd backend && poetry run python manage.py makemigrations"
echo "  3. Run:  cd backend && poetry run python manage.py migrate"
echo "  4. Run:  cd backend && poetry run python manage.py migrate --database=vectors"
echo "  5. Load WorldKG ontology: poetry run python manage.py enrich_worldkg_classes \\"
