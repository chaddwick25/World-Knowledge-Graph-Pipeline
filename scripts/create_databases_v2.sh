...
echo "     poetry run python manage.py migrate --database=vectors"
echo ""
echo "  3. Load WorldKG ontology into Redis:"
echo "     poetry run python manage.py enrich_worldkg_classes \\"
...
echo "     poetry run python manage.py harvest_wikidata_candidates \\"
...
echo "     poetry run python manage.py train_gv_nle --country DE --buffer-deg 0.45"
echo "     # Or with a precise .poly boundary file:"
echo "     poetry run python manage.py train_gv_nle \\"
