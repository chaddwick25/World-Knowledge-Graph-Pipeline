...
urlpatterns = [
    # Legacy endpoints (census tract search)
    path('search/', SemanticSearchView.as_view(), name='search'),
    path('compare/', ComparisonView.as_view(), name='compare'),
    path('training/status/', TrainingStatusView.as_view(), name='training_status'),
    path('benchmarks/', BenchmarkResultsView.as_view(), name='benchmarks'),
