...
class PbfExtract(models.Model):
    ...
    task = models.ForeignKey('orchestration.Task', on_delete=models.SET_NULL, null=True, blank=True, related_name='pbf_extracts')
...
class OSMWikiDataHierarchy(models.Model):
    ...
    # TODO: refactor to use ENVs instead of hardcoded values
    def get_default_policy(self):
        ...
        # TODO: implement a number to the admin_level mappings
