...
class Command(BaseCommand):
    help = "Create HNSW indexes on semantic_search_osmentity leaf partitions."

    def handle(self, *args, **options):
        self.stdout.write(self.style.WARNING("Creating HNSW indexes on semantic_search_osmentity (vectors DB)..."))
